...
class PdfRendererView @JvmOverloads constructor(
    ...
    // Add this to PdfRendererView class
    fun resetZoomAndNavigateToPage(pageNumber: Int, smoothScroll: Boolean = true) {
        ...
        // Navigate to page after a small delay to allow zoom reset
        recyclerView.postDelayed({
            jumpToPage(pageNumber, smoothScroll)
        }, 100) // Small delay to ensure zoom reset completes
    }
     ...
     * @param listener The listener to be notified when the page changes.
     */
    // region Interfaces
    interface StatusCallBack {
        ...
        fun onPageChanged(page: Int, totalPage: Int) {}
        fun onPdfRenderStart() {}
        fun onPdfRenderSuccess() {}
        // Add these new scroll-related callbacks
        fun onPageScrollStateChanged(state: Int) {} // SCROLL_STATE_IDLE, SCROLL_STATE_DRAGGING, SCROLL_STATE_SETTLING
        fun onPageScrolled(currentPageIndex: Int, positionOffset: Float, positionOffsetPixels: Int) {}
    }
