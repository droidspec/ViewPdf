...
object ThemeValidator {
    ...
    fun validatePdfViewerTheme(context: Context) {
        validateThemeAttributes(context, listOf(
            ...
            com.ahmed.pdfview.viewpdf.R.attr.pdfView_toolbarColor,
            com.ahmed.pdfview.viewpdf.R.attr.pdfView_backgroundColor,
            com.ahmed.pdfview.viewpdf.R.attr.pdfView_titleTextStyle
        ))
    }
}
